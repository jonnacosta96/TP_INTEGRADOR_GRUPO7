...
System.out.println(LocalDate.now().toString());	
		...
		Cliente client11 = new Cliente(1011, 31556813, "Masculino", pais1, LocalDate.now(), "Calle Prueba 10", prov3, loc2, user11, true, "UsuarioPrueba","Cliente");
		
		Empleado empleado = new Empleado(1001,"Usuario","Admin", user12);
